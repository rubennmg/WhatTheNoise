 ...
 * Final implementation using PortAudio and pthreads.
 *
 * - Efficiency performance improvements by using separate threads for opening, 
 * writing and closing files based on a queueing system.
 * - Improved detection of a period of silence by counting the number of 
 * continuous samples that do not exceed the given threshold instead of simply comparing a time difference.
 * 
 * ~ Author: rubennmg
 *
 */
